...
import abilities.LeaderKingHenselt;
...
public static Card leaderBSTM() {
	Card leader = new Leader("Jeremiah Stroup", Factions.BSTM, Type.LEADER, 14, 14, new LeaderKingHenselt("Clone a unit card on your side of the field.","No Range"), null);
	return leader;}
